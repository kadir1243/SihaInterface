...
"}")
        ...
        self.actionDownload_Fence_Mission_Data = QAction(MainWindow)
        self.actionDownload_Fence_Mission_Data.setObjectName(u"actionDownload_Fence_Mission_Data")
        self.actionDownload_Waypoint_Mission_Data = QAction(MainWindow)
        self.actionDownload_Waypoint_Mission_Data.setObjectName(u"actionDownload_Waypoint_Mission_Data")
        ...
        self.map_buttons.addWidget(self.set_fence)
        ...
        self.map_buttons.addWidget(self.add_ads, 0, Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignBottom)
        ...
        self.map_buttons.addWidget(self.remove_ads, 0, Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignBottom)
        ...
        self.map_buttons.addWidget(self.refresh_ads, 0, Qt.AlignmentFlag.AlignBottom)
        ...
        self.menuTesting.addAction(self.actionDownload_Fence_Mission_Data)
        self.menuTesting.addAction(self.actionDownload_Waypoint_Mission_Data)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionDownload_Fence_Mission_Data.setText(QCoreApplication.translate("MainWindow", u"Download Fence Mission Data", None))
        self.actionDownload_Waypoint_Mission_Data.setText(QCoreApplication.translate("MainWindow", u"Download Waypoint Mission Data", None))
